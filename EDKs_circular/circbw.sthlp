...
It is possible to choose the kernel function, Quartic (Biweight) default. With diametrically opposite data it is necessary to employ only one half of the directions. If a half variable is included, circbw asks for using only one half.
