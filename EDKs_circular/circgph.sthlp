...
{pstd}{cmd:circgph} draws around the unitary circle a kernel density estimation for circular variables from density and degrees variables generated by {cmd:circkden} or {cmd:cirkdevm} {break}
